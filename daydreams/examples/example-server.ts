...
app.get<{userId: string}>("/api/history/:userId", (async (req: Request<{userId: string}>, res: Response) => {
    try {
...
app.get<{userId: string, chatId: string}>("/api/history/:userId/:chatId", (async (req: Request<{userId: string, chatId: string}>, res: Response) => {
    try {
...
}) as RequestHandler<{userId: string, chatId: string}>);
